...
module.exports = {
  ...
  // },
  purge: ['./components//*.{js,ts,jsx,tsx}', './pages//*.{js,ts,jsx,tsx}', './src/**/*.{js,ts,jsx,tsx}'],
  darkMode: false,
  theme: {
    extend: {
  ...
  plugins: [
    ...
    plugin(function ({ addUtilities }) {
      addUtilities({
        '.header-border-b': {
          background:
            'linear-gradient(to right, rgb(230 39 39 / 20%) 0%, rgb(250 214 82 / 20%) 100%) left bottom no-repeat',
