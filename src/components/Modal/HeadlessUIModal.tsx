        ...
        <div className="relative flex items-center justify-center min-h-screen text-center block">
          ...
          >
            <Dialog.Overlay className="fixed inset-0 bg-black bg-opacity-40 transition backdrop-filter backdrop-blur-[3px] backdrop-opacity-100">
              <div className="fixed inset-0 mb-[20vw] ml-auto bg-red bg-opacity-40 w-[60vw] rounded-full z-0 filter blur-[400px] rounded-full" />
              <div className="fixed inset-0 mt-[20vw] mr-auto bg-red bg-opacity-40 w-[60vw] rounded-full z-0 filter blur-[400px] rounded-full" />
            </Dialog.Overlay>
          </Transition.Child>
