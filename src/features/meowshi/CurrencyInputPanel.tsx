            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col items-start">
                ...
                {(currency === SUSHI[ChainId.MAINNET] || currency === XSUSHI) && (
                  <Typography
                    variant="xs"
                    className="underline cursor-pointer text-yellow"
          ...
          <div className="flex items-center justify-between w-full px-3 py-2 rounded bg-dark-900 sm:w-3/5">
            ...
            {showMax && (
              <span
                ...
                className="flex items-center justify-center px-2 py-1 text-sm uppercase border border-opacity-50 cursor-pointer border-red bg-red text-red bg-opacity-30 rounded-3xl hover:border-opacity-100"
              >
                {i18n._(t`Max`)}
              </span>
            )}
