  ...
  return (
    ...
    >
      <div className="flex w-full md:w-[220px] p-4 gap-4 items-center">
        ...
        <span
          className={`uppercase border border-red bg-red text-red bg-opacity-30 border-opacity-50 py-0.5 px-1.5 text-xs rounded-3xl flex items-center justify-center ${
