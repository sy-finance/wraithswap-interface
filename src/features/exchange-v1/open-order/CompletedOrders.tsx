                  ...
                  style={{
                    background:
                      order.status === OrderStatus.FILLED
                        ? 'linear-gradient(90deg, rgba(0, 255, 79, 0.075) 0%, rgba(0, 255, 79, 0) 50%), #301f1f'
                        : order.status === OrderStatus.CANCELLED
                        ? 'linear-gradient(90deg, rgba(200, 200, 200, 0.075) 0%, rgba(200, 200, 200, 0) 50%), #301f1f'
                        : 'linear-gradient(90deg, rgba(255, 56, 56, 0.15) 0%, rgba(255, 56, 56, 0) 50%), #301f1f',
                  }}
                >
