    ...
    <div className="flex flex-col w-full gap-1">
      ...
      <div className="flex flex-row items-center gap-4 p-4 rounded bg-dark-800">
        ...
        {showMax && (
          <span
            onClick={onMax}
            className="cursor-pointer flex items-center rounded-full h-[30px] bg-red bg-opacity-30 hover:border-opacity-100 border border-red border-opacity-50 text-xs font-medium text-red px-3"
          >
            {i18n._(t`Max`)}
          </span>
        )}
