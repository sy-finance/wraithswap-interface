...
export default function Add() {
  ...
  return (
    <>
      <Head>
        <title>Add Liquidity | Wraith</title>
        <meta
          key="description"
          name="description"
          content="Add liquidity to the WraithSwap AMM to enable gas optimised and low slippage trades across Fantom"
        />
      </Head>
          ...
          message={
            noLiquidity ? (
              ...
              <>
                <b>{i18n._(t`Tip:`)}</b>{' '}
                {i18n._(
                  t`By adding liquidity you'll earn 0.30% of all trades on this pair
